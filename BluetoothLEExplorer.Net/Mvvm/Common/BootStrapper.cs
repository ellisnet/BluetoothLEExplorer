//Code from here: https://github.com/Windows-XAML/Template10/blob/version_1.1.12_vs2017/Template10%20(Library)/Common/BootStrapper.cs
...
namespace BluetoothLEExplorer.Mvvm.Common
{
    public abstract class BootStrapper : Application, INotifyPropertyChanged
    {
        ...
        public BootStrapper()
        {
            ...
            Current = this;
            //Resuming += CallResuming; //WPF application doesn't have this
            //Suspending += CallHandleSuspendingAsync; //WPF application doesn't have this
        }
