//Code from here: https://github.com/Windows-XAML/Template10/blob/version_1.1.12_vs2017/Template10%20(Library)/Services/NavigationService/NavigationService.cs
...
using BluetoothLEExplorer.Mvvm.Services.SerializationService;
...
namespace BluetoothLEExplorer.Mvvm.Services.NavigationService
{
    ...
    public partial class NavigationService : INavigationService
    {
        ...
        public async Task<bool> NavigateAsync(Type page, object parameter = null)
        {
            DebugWrite($"Page: {page}, Parameter: {parameter}");
            ...
            return FrameFacadeInternal.Navigate(page, parameter);
        }
        ...
        public void Navigate(Type page, object parameter = null)
        {
            ...
            NavigateAsync(page, parameter).ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public async Task<bool> NavigateAsync<T>(T key, object parameter = null)
            where T : struct, IConvertible
        {
            DebugWrite($"Key: {key}, Parameter: {parameter}");
            ...
            return await NavigateAsync(page, parameter).ConfigureAwait(false);
        }

        public void Navigate<T>(T key, object parameter = null)
            where T : struct, IConvertible
        {
            DebugWrite($"Key: {key}, Parameter: {parameter}");

            NavigateAsync(key, parameter).ConfigureAwait(false).GetAwaiter().GetResult();
        }
        ...
        public void GoBack()
        {
            if (FrameFacadeInternal.CanGoBack) FrameFacadeInternal.GoBack();
        }
