//Code from here: https://github.com/Windows-XAML/Template10/blob/version_1.1.12_vs2017/Template10%20(Library)/Services/NavigationService/FrameFacade.cs
...
using BluetoothLEExplorer.Mvvm.Services.SettingsService;
...
namespace BluetoothLEExplorer.Mvvm.Services.NavigationService
{
    ...
    public class FrameFacade
    {
        ...
        internal FrameFacade(NavigationService navigationService, Frame frame)
        {
            ...
            // setup animations - Not appropriate for WPF
